# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 14:49:01 2019
...
def main():
    ...
    global tb1; tb1 = 29.0
    global tb2; tb2 = 22.0
    global fT1; fT1 = 95.0e3
    global fT2; fT2 = 15.0e3 
    global m01; m01 = 19613.73
    global m02; m02 = 4128
    global mL;  mL = 80.0
    global mp1; mp1 = 14401.35 
    global mp2; mp2 = 3845.98 
    ...
    state_ode_f = integrate.ode(rocket)
    state_ode_f.set_integrator('dopri5', rtol=5e-12, atol=5e-15, nsteps=1e8, max_step=1e-3) 
    ...
    while state_ode_f.successful() and state_ode_f.t <= (t_final):
        ...
        print("{0:0.8f}\t {1:0.4e} \t{2:10.3e}\t {3:0.3e}\t {4}".format(state_ode_f.t, state_ode_f.y[0], state_ode_f.y[1], state_ode_f.y[2], state_ode_f.y[3], state_ode_f.y[4], state_ode_f.y[5], state_ode_f.successful()))
