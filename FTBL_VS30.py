...
def main():
    # Legend
    Legend = [str('Ethanol|LOx'), str('UDMH|N2O4'), str('Kerosene|LOx'), str('Methane|LOx')] 
    # Parameters
    Isp_1 = 200.0; Delta_v = 9.5e3; PL = 80.0 # Payload [kg]
    ...
    plt.plot(A[3,:], P[3,:]*P[3,:]*A[3,:],'.', label = r'$\beta_2 = 1.75$')
